                            ...
                            if load_all_lods and isinstance(result, dict):
                                ...
                                for lod, (vertices, faces) in result.items():
                                    ...
                                    if manifest and "lod_scales" in manifest:
                                        ...
                                        # we need specific scale adjustments for each LOD:
                                        if lod == 0:
                                            mesh_scale = scale.copy() / 4.0  # Divide by 4 for LOD 0
                                        elif lod == 1:
                                            mesh_scale = scale.copy() / 2.0  # Divide by 2 for LOD 1
                                        else:
                                            mesh_scale = scale.copy()  # No adjustment for LOD 2+
