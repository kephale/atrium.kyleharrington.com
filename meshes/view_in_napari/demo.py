                            ...
                            if load_all_lods and isinstance(result, dict):
                                ...
                                for lod, (vertices, faces) in result.items():
                                    ...
                                    if manifest and "lod_scales" in manifest:
                                        # Based on testing with meshes generated by meshes/complete_blobs_demo/0.0.1.py,
                                        # we've found that all LOD levels need to be scaled by 1/4 for proper display
                                        # This is likely due to how the mesh coordinates are generated relative to the image data
                                        # Apply a uniform 1/4 scale factor to all LOD levels
